...
if (!function_exists('spyc_load')) {
    ...
    function spyc_load ($string) {
        return Services_Stormpath_Util_Spyc::YAMLLoadString($string);
    }
}
...
if (!function_exists('spyc_load_file')) {
    ...
    function spyc_load_file ($file) {
        return Services_Stormpath_Util_Spyc::YAMLLoad($file);
    }
}
 ...
 * Usage:
 * <code>
 *   $Spyc  = new Services_Stormpath_Util_Spyc;
 *   $array = $Spyc->load($file);
 * </code>
 * or:
 * <code>
 *   $array = Services_Stormpath_Util_Spyc::YAMLLoad($file);
 * </code>
 * or:
 * <code>
 ...
 * </code>
 */
class Services_Stormpath_Util_Spyc {
     ...
     *  Usage:
     *  <code>
     *   $array = Services_Stormpath_Util_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
     ...
     *  Usage:
     *  <code>
     *   $array = Services_Stormpath_Util_Spyc::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
